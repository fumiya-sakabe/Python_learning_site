...
- <strong class="term">リスト</strong>: 順序が重要、重複可能、変更可能
- <strong class="term">タプル</strong>: 順序が重要、重複可能、変更不可
- <strong class="term">辞書</strong>: キーでアクセス、変更可能、キーは重複不可
- <strong class="term">集合</strong>: 順序なし、重複不可、変更可能
...
問2. 辞書のループ処理を使って、全てのキーと値を表示してください：
...
問5. 辞書を使って、単語と意味の対応を作成してください（辞書型の辞書）：
