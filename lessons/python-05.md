...
2. リスト`[1, 2, 3, 4, 5]`の各要素を2倍して表示してください。
...
3. `while`文を使って、1から100までの合計を計算してください。
...
4. 1から20までの数字で、3の倍数だけを表示してください（`continue`を使う）。
...
6. ユーザーが正しい答えを入力するまで繰り返すプログラムを作成してください：
