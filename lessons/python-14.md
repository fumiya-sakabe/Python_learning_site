...
3. カンマ区切りの文字列を分割して、各要素を処理してください：
...
4. 正規表現を使って、文字列からメールアドレスらしき文字列を抽出してください：
...
5. 文字列のスライスを使って、ファイル名から拡張子を取得してください：
